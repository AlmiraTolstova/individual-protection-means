...
const Sidebar = () => {
    return (
        <div className='sidebar'>
            <Nav variant="pills" defaultActiveKey="/home" className="flex-column sidebar ">
                <Nav.Link className='sidebar__cell-height' href="/home">
                    Мой склад
                </Nav.Link>
                <Nav.Link eventKey="link-1">
                    ...
                    <span className='sidebar__icon-height'>Добавить сотрудника</span>
                </Nav.Link>
                <Nav.Link eventKey="link-2">
                    ...
                    <span className='sidebar__icon-height'>Сотрудники</span>
                </Nav.Link>
                <Nav.Link eventKey="link-3">
                    ...
                    <span className='sidebar__icon-height'>Закупка</span>
                </Nav.Link>
                <Nav.Link eventKey="link-4">
                    ...
                    <span className='sidebar__icon-height'>Склад</span>
                </Nav.Link>
                <Nav.Link eventKey="link-5">
                    ...
                    <span className='sidebar__icon-height'>Выдача</span>
                </Nav.Link>
                <Nav.Link eventKey="link-6">
                    ...
                    <span className='sidebar__icon-height'>Списание</span>
                </Nav.Link>
                <Nav.Link eventKey="link-7">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                         className="bi bi-journal-album" viewBox="0 0 16 16">
                        <path
                    ...
                    <span className='sidebar__icon-height'>Норма выдачи</span>
                </Nav.Link>
